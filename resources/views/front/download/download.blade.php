        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-12 p-0">
                <div class="int_home_crumbs">
                    <ul>
                        <li><a href="index.html">Home // </a><span> Download</span></li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-4 col-sm-12">
                    <div class="blog_box">
                        <div class="blog_img">
                            <a href="#">
                                <img src="assets/images/download1.jpg" class="img-fluid" alt="image">
                            </a>
                        </div>
                ...
                <div class="col-lg-3 col-md-4 col-sm-12">
                    <div class="blog_box">
                        <div class="blog_img">
                            <a href="#">
                                <img src="assets/images/download2.png" class="img-fluid" alt="image">
                            </a>
                        </div>
                ...
                <div class="col-lg-3 col-md-4 col-sm-12">
                    <div class="blog_box">
                        <div class="blog_img">
                            <a href="#">
                                <img src="assets/images/Airo-Exterior.png" class="img-fluid" alt="image">
                            </a>
                        </div>
                ...
                <div class="col-lg-3 col-md-4 col-sm-12">
                    <div class="blog_box">
                        <div class="blog_img">
                            <a href="#">
                                <img src="assets/images/Classico.png" class="img-fluid" alt="image">
                            </a>
                        </div>
                ...
                <div class="col-lg-3 col-md-4 col-sm-12">
                    <div class="blog_box">
                        <div class="blog_img">
                            <a href="#">
                                <img src="assets/images/I-Lam.png" class="img-fluid" alt="image">
                            </a>
                        </div>
                ...
                <div class="col-lg-3 col-md-4 col-sm-12">
                    <div class="blog_box">
                        <div class="blog_img">
                            <a href="#">
                                <img src="assets/images/Airolite-2.png" class="img-fluid" alt="image">
                            </a>
                        </div>
                ...
                <div class="col-lg-3 col-md-4 col-sm-12">
                    <div class="blog_box">
                        <div class="blog_img">
                            <a href="#">
                                <img src="assets/images/1.png" class="img-fluid" alt="image">
                            </a>
                        </div>
