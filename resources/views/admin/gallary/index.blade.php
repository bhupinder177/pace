...
<div class="page-content">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-6">
                {{-- <form action="{{route('gallary.index')}}" method="get">
                    <div class="row">
                        <div class="col-md-7">
                            <div class="form-group">
                                <input class="form-control search" placeholder="Search" type="text">
                                <input type="hidden" class="searchpagelink" value="{{route('gallary.index')}}">
                            </div>
                        </div>
                        ...
                        <div class="col-3 col-md-2">
                            <div class="form-group">
                                <a class="btn btn-success getreset" value="Reset" data-href="{{route('gallary.index')}}">Reset</a>
                            </div>
                        </div>
                    </div>
                </form> --}}
            ...
            <div class="col-md-6">
                <div class="refer-btn">
                     <a class="btn btn-rounded" href="{{route('gallary.add')}}">Add Gallary</a>
                </div>
            </div>
        </div>
