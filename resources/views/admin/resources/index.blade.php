...
<div class="page-content">
    ...
    <div class="container-fluid">
        <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-7">
                            <div class="form-group">
                                ...
                                <input type="hidden" class="searchpagelink" value="{{route('resources.index')}}">
                            </div>
                        </div>
                        ...
                        <div class="col-3 col-md-2">
                            <div class="form-group">
                                <a class="btn btn-success getreset" value="Reset" data-href="{{route('resources.index')}}">Reset</a>
                            </div>
                        </div>
                    </div>
                </form> --}}
            ...
            <div class="col-md-6">
                <div class="refer-btn">
                     <a class="btn btn-rounded" href="{{route('resources.add')}}">Add Resources</a>
                </div>
            </div>
        </div>
