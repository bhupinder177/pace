...
<div class="page-content">
    ...
    <div class="container-fluid">
        <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-7">
                            <div class="form-group">
                                ...
                                <input type="hidden" class="searchpagelink" value="{{route('investor.index')}}">
                            </div>
                        </div>
                        ...
                        <div class="col-3 col-md-2">
                            <div class="form-group">
                                <a class="btn btn-success getreset" value="Reset" data-href="{{route('investor.index')}}">Reset</a>
                            </div>
                        </div>
                    </div>
                </form>
            ...
            <div class="col-md-6">
                <div class="refer-btn">
                     <a class="btn btn-rounded" href="{{route('investor.add')}}">Add Investor</a>
                </div>
            </div>
        </div>
